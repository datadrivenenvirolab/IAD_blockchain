...
def scrape(organizations):
    ...
    for i in range(len(org_list)):
        ...
        print("Found {} links for {} ".format(len(list_of_links),organization))
...
if __name__ == "__main__":
    ...
    final_df = pd.concat(scraping_result_dfs)
    final_df.to_csv("scraped_websites.csv", encoding='utf-8-sig')
